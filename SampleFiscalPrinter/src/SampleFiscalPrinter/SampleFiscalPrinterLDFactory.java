...
/**
 * Factory class for LineDisplay device class of sample fiscal printer service implementation
 */
public class SampleFiscalPrinterLDFactory extends Factory implements JposServiceInstanceFactory {
    @Override
