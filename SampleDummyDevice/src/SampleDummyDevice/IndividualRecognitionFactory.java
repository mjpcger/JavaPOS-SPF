...
/**
 * Factory class for sample IndividualRecognition device implementation
 */
@SuppressWarnings("unused")
public class IndividualRecognitionFactory extends Factory implements JposServiceInstanceFactory {
    @Override
    public JposServiceInstance createInstance(String s, JposEntry jposEntry) throws JposException {
         try {
            ...
            synchronized(Devices) {
                if (deviceClass.equals("IndividualRecognition")) {
                    JposDevice any = getDevice("SampleIndividualRecognition");
                    IndividualRecognitionDevice dev;
                    ...
                    IndividualRecognitionService srv = addDevice(0, dev, jposEntry);
                    if (create)
                        putDevice("SampleIndividualRecognition", dev);
                    return srv;
                }
            }
