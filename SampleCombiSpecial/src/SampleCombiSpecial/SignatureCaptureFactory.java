...
import de.gmxhome.conrad.jpos.jpos_base.signaturecapture.Factory;
...
/**
 * Factory class for SignatureCapture Device of sample implementation.
 */
public class SignatureCaptureFactory extends Factory implements JposServiceInstanceFactory {
    @Override
    public JposServiceInstance createInstance(String s, JposEntry jposEntry) throws JposException {
        try {
            ...
            synchronized(Devices) {
                if (deviceClass.equals("SignatureCapture")) {
