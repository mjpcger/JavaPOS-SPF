...
/**
 * Factory class for VLC SoundRecorder device implementation
 */
@SuppressWarnings("unused")
public class SoundRecorderFactory extends Factory implements JposServiceInstanceFactory {
    @Override
        ...
        try {
            ...
            synchronized(Devices) {
                if (deviceClass.equals("SoundRecorder")) {
                    JposDevice any = getDevice("VlcDevice");
                    Device dev;
                    ...
                    SoundRecorderService srv = addDevice(0, dev, jposEntry);
                    if (create)
                        putDevice("VlcDevice", dev);
                    return srv;
                }
            }
