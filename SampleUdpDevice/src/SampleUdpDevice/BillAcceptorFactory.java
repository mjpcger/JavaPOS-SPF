...
import de.gmxhome.conrad.jpos.jpos_base.billacceptor.Factory;
...
/**
 * Factory class for BillAcceptor device class of sample UDP service implementation.
 */
public class BillAcceptorFactory extends Factory implements JposServiceInstanceFactory {
    @Override
    public JposServiceInstance createInstance(String s, JposEntry jposEntry) throws JposException {
        try {
            ...
            synchronized(Devices) {
                if (deviceClass.equals("BillAcceptor")) {
