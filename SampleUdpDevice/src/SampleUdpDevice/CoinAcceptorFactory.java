...
import de.gmxhome.conrad.jpos.jpos_base.coinacceptor.Factory;
...
/**
 * Factory class for CoinAcceptor device class of sample UDP service implementation.
 */
public class CoinAcceptorFactory extends Factory implements JposServiceInstanceFactory {
    @Override
    public JposServiceInstance createInstance(String s, JposEntry jposEntry) throws JposException {
        try {
            ...
            synchronized(Devices) {
                if (deviceClass.equals("CoinAcceptor")) {
