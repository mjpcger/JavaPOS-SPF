 ...
 */
public class ElectronicValueRWFactory extends Factory implements JposServiceInstanceFactory {
    @Override
    public JposServiceInstance createInstance(String s, JposEntry jposEntry) throws JposException {
        try {
            ...
            synchronized (JposDeviceFactory.Devices) {
                if (deviceClass.equals("ElectronicValueRW")) {
                    JposDevice any = JposDeviceFactory.getDevice(port);
                    Device dev;
