...
/**
 * Output request executor for CAT method AuthorizeRefund.
 */
public class AuthorizeRefund extends AuthorizeCompletion {
     ...
     */
    public AuthorizeRefund(CATProperties data, int sequenceNumber, long amount, long taxOthers, int timeout) {
        super(data, sequenceNumber, amount, taxOthers, timeout);
    }

    @Override
    public void invoke() throws JposException {
        ((CATService)Props.EventSource).CatInterface.authorizeRefund(this);
    }
}
