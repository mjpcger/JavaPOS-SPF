...
/**
 * Output request executor for CAT method AuthorizeVoidPreSales.
 */
public class AuthorizeVoidPreSales extends AuthorizeCompletion {
     ...
     */
    public AuthorizeVoidPreSales(CATProperties data, int sequenceNumber, long amount, long taxOthers, int timeout) {
        super(data, sequenceNumber, amount, taxOthers, timeout);
    }

    @Override
    public void invoke() throws JposException {
        ((CATService)Props.EventSource).CatInterface.authorizeVoidPreSales(this);
    }
}
