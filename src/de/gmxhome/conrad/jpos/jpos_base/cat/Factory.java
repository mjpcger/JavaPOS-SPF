...
public class Factory extends JposDeviceFactory {
     ...
     */
    public CATService addDevice(int index, JposDevice dev, JposEntry entry) throws JposException {
        CATProperties props = dev.getCATProperties(index);
        validateJposConfiguration(props, dev, dev.ClaimedCAT, entry);
        CATService service = (CATService) (props.EventSource = new CATService(props, dev));
