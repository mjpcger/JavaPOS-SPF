...
/**
 * Output request executor for CAT method AuthorizeVoid.
 */
public class AuthorizeVoid extends AuthorizeCompletion {
     ...
     */
    public AuthorizeVoid(CATProperties data, int sequenceNumber, long amount, long taxOthers, int timeout) {
        super(data, sequenceNumber, amount, taxOthers, timeout);
    }

    @Override
    public void invoke() throws JposException {
        ((CATService)Props.EventSource).CatInterface.authorizeVoid(this);
    }
}
