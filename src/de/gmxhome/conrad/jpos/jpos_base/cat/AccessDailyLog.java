...
/**
 * Output request executor for CAT method AccessDailyLog.
 */
public class AccessDailyLog extends CheckCard {
     ...
     */
    public AccessDailyLog(CATProperties data, int sequenceNumber, int type, int timeout) {
    ...
    public void invoke() throws JposException {
        ((CATService)Props.EventSource).CatInterface.accessDailyLog(this);
    }
}
