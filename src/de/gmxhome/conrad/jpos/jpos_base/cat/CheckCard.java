...
public class CheckCard extends OutputRequest {
    ...
    /**
     * Get the maximum waiting time (in milliseconds) until the response is received from the CAT device.
     * @return The maximum waiting time (in milliseconds) until the response is received from the CAT device.
     */
     ...
     */
    public CheckCard(CATProperties data, int sequenceNumber, int timeout) {
        super(data);
    ...
    public void invoke() throws JposException {
        ((CATService)Props.EventSource).CatInterface.checkCard(this);
    }
}
