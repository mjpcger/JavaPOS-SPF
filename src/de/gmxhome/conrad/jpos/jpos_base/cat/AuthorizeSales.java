...
/**
 * Output request executor for CAT method AuthorizeSales.
 */
public class AuthorizeSales extends AuthorizeCompletion {
     ...
     */
    public AuthorizeSales(CATProperties data, int sequenceNumber, long amount, long taxOthers, int timeout) {
        super(data, sequenceNumber, amount, taxOthers, timeout);
    }

    @Override
    public void invoke() throws JposException {
        ((CATService)Props.EventSource).CatInterface.authorizeSales(this);
    }
}
