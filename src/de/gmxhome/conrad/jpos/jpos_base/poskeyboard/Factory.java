...
public class Factory extends JposDeviceFactory {
     ...
     */
    public POSKeyboardService addDevice(int index, JposDevice dev, JposEntry entry) throws JposException {
        POSKeyboardProperties props = dev.getPOSKeyboardProperties(index);
        validateJposConfiguration(props, dev, dev.ClaimedPOSKeyboard, entry);
        POSKeyboardService service = (POSKeyboardService) (props.EventSource = new POSKeyboardService(props, dev));
