...
public class Factory extends JposDeviceFactory {
     ...
     * @param index SpeechSynthesis  property set index.
     * @param dev SpeechSynthesis implementation instance derived from JposDevice to be used by the service.
     * @param entry Property list from jpos configuration.
     * @return SpeechSynthesisService object.
