...
/**
 * Output request executor for FiscalPrinter method PrintRecRefund.
 */
public class PrintRecRefund extends SimpleItemOutputRequest {
    /**
     ...
     */
    public PrintRecRefund(FiscalPrinterProperties props, String description, long amount, int vatInfo) {
        super(props, description, amount, vatInfo);
    }

    @Override
    public void invokeMethod() throws JposException {
        ((FiscalPrinterProperties)Props).printRecRefund(this);
    }
}
