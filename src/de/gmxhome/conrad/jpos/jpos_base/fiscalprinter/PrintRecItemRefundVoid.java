...
/**
 * Output request executor for FiscalPrinter method PrintRecItemRefundVoid.
 */
public class PrintRecItemRefundVoid extends PrintRecItem {
    /**
     ...
     */
    public PrintRecItemRefundVoid(FiscalPrinterProperties props, String description, long price, int quantity, int vatInfo, long unitPrice, String unitName) {
