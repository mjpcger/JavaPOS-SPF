 ...
 */
public class FiscalPrinterException extends JposException {
    /**
     ...
     * @param state     Error state, see UPOS specification of property ErrorLevel.
     */
    public FiscalPrinterException(int error, int extension, String message, Exception e, int station, int level, int state) {
