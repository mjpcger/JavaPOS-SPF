...
/**
 * Output request executor for FiscalPrinter method PrintRecRefundVoid.
 */
public class PrintRecRefundVoid extends SimpleItemOutputRequest {
    /**
     ...
     */
    public PrintRecRefundVoid(FiscalPrinterProperties props, String description, long amount, int vatInfo) {
        super(props, description, amount, vatInfo);
    }

    @Override
    public void invokeMethod() throws JposException {
        ((FiscalPrinterProperties)Props).printRecRefundVoid(this);
    }
}
