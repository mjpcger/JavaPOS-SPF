 ...
 * see JposBase.
 */
public class BillAcceptorService extends JposBase implements BillAcceptorService116 {
    /**
     * Instance of a class implementing the BillAcceptorInterface for bill acceptor specific setter and method calls bound
     * to the property set. Almost always the same object as Data.
     */
    public BillAcceptorInterface BillAcceptorInterface;

    private final BillAcceptorProperties Data;
    ...
    public void beginDeposit() throws JposException {
        ...
        checkEnabled();
        check(Data.DepositStatus != BACC_STATUS_DEPOSIT_END, JPOS_E_ILLEGAL,
                (Data.DepositStatus == BACC_STATUS_DEPOSIT_JAM) ? "Jam condition" : "Just in deposit operation");
    ...
    public void endDeposit(int success) throws JposException {
        ...
        checkEnabled();
        check(Data.DepositStatus != BACC_STATUS_DEPOSIT_COUNT, JPOS_E_ILLEGAL,
                (Data.DepositStatus == BACC_STATUS_DEPOSIT_JAM) ? "Jam condition" : "Operation not fixed");
        check(success != BACC_DEPOSIT_COMPLETE, JPOS_E_ILLEGAL, "Invalid success code: " + success);
    ...
    public void fixDeposit() throws JposException {
        ...
        checkEnabled();
        check(Data.DepositStatus != BACC_STATUS_DEPOSIT_START, JPOS_E_ILLEGAL,
                (Data.DepositStatus == BACC_STATUS_DEPOSIT_JAM ? "Jam condition" :
                        (Data.DepositStatus == BACC_STATUS_DEPOSIT_END ? "Operation not started" : "Operation just fixed")));
    ...
    public void pauseDeposit(int control) throws JposException {
        ...
        check(control == BACC_DEPOSIT_PAUSE && Data.DepositStatus == BACC_STATUS_DEPOSIT_END,
                JPOS_E_ILLEGAL, "No pending deposit operation");
        long[] allowed = {BACC_DEPOSIT_PAUSE, BACC_DEPOSIT_RESTART };
