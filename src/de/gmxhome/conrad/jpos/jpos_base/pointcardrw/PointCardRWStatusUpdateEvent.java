...
public class PointCardRWStatusUpdateEvent extends JposStatusUpdateEvent {
    ...
    public boolean setStatusProperties() {
        ...
        switch (getStatus()) {
        case PCRW_SUE_NOCARD:
            return extracted(props, PCRW_STATE_NOCARD);
        case PCRW_SUE_REMAINING:
            return extracted(props, PCRW_STATE_REMAINING);
        case PCRW_SUE_INRW:
            return extracted(props, PCRW_STATE_INRW);
        }
        return false;
    }
    ...
    public boolean checkStatusCorresponds() {
        ...
        switch (getStatus()) {
        case PCRW_SUE_NOCARD:
            return props.CardState == PCRW_STATE_NOCARD;
        case PCRW_SUE_REMAINING:
            return props.CardState == PCRW_STATE_REMAINING;
        case PCRW_SUE_INRW:
            return props.CardState == PCRW_STATE_INRW;
        }
        return false;
    }
