...
/**
 * Output request executor for ElectronicValueRW method AuthorizePreSales.
 */
public class AuthorizePreSales extends AuthorizeCompletion {
     ...
     */
    public AuthorizePreSales(ElectronicValueRWProperties data, int sequenceNumber, long amount, long taxOthers, int timeout) {
        super(data, sequenceNumber, amount, taxOthers, timeout);
    }

    @Override
    public void invoke() throws JposException {
        ((ElectronicValueRWService)Props.EventSource).ElectronicValueRW.authorizePreSales(this);
    }
}
