...
/**
 * Output request executor for ElectronicValueRW method AuthorizeVoidPreSales.
 */
public class AuthorizeVoidPreSales extends AuthorizeCompletion {
    /**
     ...
     */
    public AuthorizeVoidPreSales(ElectronicValueRWProperties data, int sequenceNumber, long amount, long taxOthers, int timeout) {
        super(data, sequenceNumber, amount, taxOthers, timeout);
    }

    @Override
    public void invoke() throws JposException {
        ((ElectronicValueRWService)Props.EventSource).ElectronicValueRW.authorizeVoidPreSales(this);
    }
}
