...
public class CheckServiceRegistrationToMedium extends NumberTimeoutRequest {
     ...
     */
    public CheckServiceRegistrationToMedium(ElectronicValueRWProperties props, int sequenceNumber, int timeout) {
        super(props, sequenceNumber, timeout);
    }

    @Override
    public void invoke() throws JposException {
        ((ElectronicValueRWService)Props.EventSource).ElectronicValueRW.checkServiceRegistrationToMedium(this);
    }
}
