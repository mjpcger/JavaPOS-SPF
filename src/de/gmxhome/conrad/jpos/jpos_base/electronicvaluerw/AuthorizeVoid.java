...
/**
 * Output request executor for ElectronicValueRW method AuthorizeVoid.
 */
public class AuthorizeVoid extends AuthorizeCompletion {
    /**
     ...
     */
    public AuthorizeVoid(ElectronicValueRWProperties data, int sequenceNumber, long amount, long taxOthers, int timeout) {
        super(data, sequenceNumber, amount, taxOthers, timeout);
    }

    @Override
    public void invoke() throws JposException {
        ((ElectronicValueRWService)Props.EventSource).ElectronicValueRW.authorizeVoid(this);
    }
}
