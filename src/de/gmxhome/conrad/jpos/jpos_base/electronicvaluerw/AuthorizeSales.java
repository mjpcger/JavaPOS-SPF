...
/**
 * Output request executor for ElectronicValueRW method AuthorizeSales.
 */
public class AuthorizeSales extends AuthorizeCompletion {
    /**
     ...
     */
    public AuthorizeSales(ElectronicValueRWProperties data, int sequenceNumber, long amount, long taxOthers, int timeout) {
        super(data, sequenceNumber, amount, taxOthers, timeout);
    }

    @Override
    public void invoke() throws JposException {
        ((ElectronicValueRWService)Props.EventSource).ElectronicValueRW.authorizeSales(this);
    }
}
