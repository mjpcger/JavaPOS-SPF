...
/**
 * Interface for methods that implement property setter and method calls for the CoinAcceptor device category.
 ...
 */
public interface CoinAcceptorInterface  extends JposBaseInterface {
    /**
     ...
     * <ul>
     *     <li>Device is enabled,</li>
     *     <li>cashCounts consists of a comma separated, not empty list of integer value pairs separated by double-point.</li>
     * </ul>
     *
