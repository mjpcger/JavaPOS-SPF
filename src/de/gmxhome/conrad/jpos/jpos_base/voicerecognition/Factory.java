...
public class Factory extends JposDeviceFactory {
     ...
     * @param index VoiceRecognition  property set index.
     * @param dev VoiceRecognition implementation instance derived from JposDevice to be used by the service.
     * @param entry Property list from jpos configuration.
     * @return VoiceRecognitionService object.
