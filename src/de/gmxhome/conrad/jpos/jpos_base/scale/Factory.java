...
public class Factory extends JposDeviceFactory {
     ...
     */
    public ScaleService addDevice(int index, JposDevice dev, JposEntry entry) throws JposException {
        ScaleProperties props = dev.getScaleProperties(index);
        validateJposConfiguration(props, dev, dev.ClaimedScale, entry);
        ScaleService service = (ScaleService) (props.EventSource = new ScaleService(props, dev));
