...
/**
 * Output request executor for RFIDScanner method LockTag.
 */
public class LockTag extends RFIDRequest {
    /**
     ...
     */
    public LockTag(RFIDScannerProperties props, byte[] tagID, int timeout, byte[] password) {
        super(props, tagID, timeout, password);
    }

    @Override
    public void invoke() throws JposException {
        ((RFIDScannerService)Props.EventSource).RFIDScanner.lockTag(this);
    }
}
