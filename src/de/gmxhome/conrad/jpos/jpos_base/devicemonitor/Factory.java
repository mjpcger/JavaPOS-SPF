...
public class Factory extends JposDeviceFactory {
     ...
     * @param index DeviceMonitor  property set index.
     * @param dev DeviceMonitor implementation instance derived from JposDevice to be used by the service.
     * @param entry Property list from jpos configuration.
     * @return DeviceMonitorService object.
