...
/**
 * Remote Order Display output complete event class. Holds display unit and error message.
 */
public class RemoteOrderDisplayOutputCompleteEvent extends JposOutputCompleteEvent {
    /**
     ...
     */
    public RemoteOrderDisplayOutputCompleteEvent(JposBase source, int id, int units) {
        super(source, id);
        Units = units;
    }
