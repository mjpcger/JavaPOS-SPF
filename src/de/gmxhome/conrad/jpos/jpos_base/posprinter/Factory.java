...
public class Factory extends JposDeviceFactory {
     ...
     */
    public POSPrinterService addDevice(int index, JposDevice dev, JposEntry entry) throws JposException {
        POSPrinterProperties props = dev.getPOSPrinterProperties(index);
        validateJposConfiguration(props, dev, dev.ClaimedPOSPrinter, entry);
        POSPrinterService service = (POSPrinterService) (props.EventSource = new POSPrinterService(props, dev));
